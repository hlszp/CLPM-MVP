...
日期：2026-06-21（对齐 v3.0/v4.0 基线）
范围：项目目录下所有设计、需求、调研和评估文档
历史版本：2026-06-16（已废弃，被本版取代）

## 1. 结论

当前文档体系采用 **v3.0/v4.0 基线**，所有 v2.x 及更早版本已废弃。有效文档统一存放于 `docs/设计文档/`，历史文档存放于 `docs/归档文档/`，过程记录存放于 `docs/过程文档/`。

```text
.
├── README.md                                    # 项目入口与当前共识
├── CLAUDE.md                                    # Agent 指引与基线
├── DESIGN.md                                    # 原型设计基线（v2.0，对齐 v3.0/v4.0）
├── docs/
│   ├── 设计文档/
│   │   ├── 01-PRD/PRD.md                        # v3.0 唯一事实来源
│   │   ├── 02-FDS/FDS.md                        # v3.0
│   │   ├── 03-ADS/ADS.md                        # v3.0
│   │   ├── 04-DDS/DDS.md                        # v3.0
│   │   ├── 05-IDS/IDS.md                        # v3.0
│   │   ├── 06-UIUX/ui-ux-design-guidelines.md   # v4.0 唯一 UI/UX 输入
│   │   └── prototype/                           # 原型代码库
│   ├── 过程文档/                                 # 过程记录（历史追溯）
│   ├── 归档文档/                                 # 历史失效版本
│   └── 预研文档/                                 # 竞品/市场/标准预研
...
| 顺序 | 文档 | 定位 | 版本 |
|---:|---|---|---|
| 1 | `docs/设计文档/01-PRD/PRD.md` | **唯一事实来源**，产品需求规范 | v3.0 |
| 2 | `docs/设计文档/02-FDS/FDS.md` | 功能设计规范，含 RBAC 矩阵与 UAT | v3.0 |
| 3 | `docs/设计文档/03-ADS/ADS.md` | 应用架构与服务设计 | v3.0 |
| 4 | `docs/设计文档/04-DDS/DDS.md` | 数据模型设计（13 PG 表 + TDengine 超表） | v3.0 |
| 5 | `docs/设计文档/05-IDS/IDS.md` | API 接口设计（30+ API 跨 6 模块） | v3.0 |
| 6 | `docs/设计文档/06-UIUX/ui-ux-design-guidelines.md` | **唯一 UI/UX 输入**，25 页面设计规范 | v4.0 |
| 7 | `DESIGN.md` | 原型设计基线（视觉/布局/组件/验收横切约束） | v2.0 |
...
3. `docs/设计文档/01-PRD/PRD.md` v3.0
4. `README.md`（当前共识）
...
1. `docs/设计文档/01-PRD/PRD.md` v3.0
2. `docs/设计文档/06-UIUX/ui-ux-design-guidelines.md` v4.0
3. `docs/设计文档/02-FDS/FDS.md` v3.0
...
1. `docs/设计文档/01-PRD/PRD.md` v3.0
2. `docs/设计文档/03-ADS/ADS.md` v3.0
3. `docs/设计文档/04-DDS/DDS.md` v3.0
...
2. `docs/设计文档/03-ADS/ADS.md` v3.0
3. `docs/设计文档/04-DDS/DDS.md` v3.0
4. `docs/设计文档/05-IDS/IDS.md` v3.0
5. `docs/设计文档/02-FDS/FDS.md` v3.0
6. `docs/设计文档/06-UIUX/ui-ux-design-guidelines.md` v4.0
7. `DESIGN.md` v2.0
...
1. `docs/设计文档/06-UIUX/ui-ux-design-guidelines.md` v4.0
2. `DESIGN.md` v2.0
3. `docs/设计文档/05-IDS/IDS.md` v3.0（mock data 契约）
4. `docs/设计文档/01-PRD/PRD.md` v3.0（业务语义）
...
1. `docs/设计文档/01-PRD/PRD.md` v3.0
2. `docs/设计文档/02-FDS/FDS.md` v3.0（UAT 清单 TC-01 至 TC-20）
3. `docs/设计文档/04-DDS/DDS.md` v3.0（数据模型）
4. `docs/预研文档/control-loop-pid-demand-research-2026-06-15.md`
...
### 3.1 当前有效主文档（v3.0/v4.0 基线）

| 文档 | 用途 | 是否必读 |
|---|---|---|
| `docs/设计文档/01-PRD/PRD.md` v3.0 | **唯一事实来源**，产品需求规范 | 是 |
| `docs/设计文档/02-FDS/FDS.md` v3.0 | 功能设计规范，含 RBAC 矩阵与 UAT | 是 |
| `docs/设计文档/03-ADS/ADS.md` v3.0 | 应用架构与服务设计 | 是 |
| `docs/设计文档/04-DDS/DDS.md` v3.0 | 数据模型设计 | 是 |
| `docs/设计文档/05-IDS/IDS.md` v3.0 | API 接口设计 | 是 |
| `docs/设计文档/06-UIUX/ui-ux-design-guidelines.md` v4.0 | **唯一 UI/UX 输入**，25 页面设计规范 | 是 |
| `DESIGN.md` v2.0 | 原型设计基线（横切约束） | 前端必读 |
| `README.md` | 项目入口与当前共识 | 是 |

说明：

- v3.0/v4.0 已吸收所有 v2.x 内容、approved 产品化架构、CEO/工程/设计三轮评审结论。
- 后续所有功能清单、原型设计、研发拆解、投标响应统一以 v3.0/v4.0 为准。
...
| `docs/归档文档/product-requirements-specification-v0.4-2026-06-16.md` | v0.4 历史基线（已被 PRD v3.0 取代） | 否 |
...
| `docs/归档文档/full-product-menu-ia-v0.1-2026-06-16.md` | 历史菜单定稿（已并入 UI/UX v4.0） | 否 |
...
| `docs/归档文档/prototype-visual-tokens-v0.1-2026-06-16.md` | 历史视觉 token（被 UI/UX v4.0 §3 覆盖） | 否 |
| `docs/归档文档/prototype-responsive-accessibility-v0.1-2026-06-16.md` | 历史响应式（被 UI/UX v4.0 §2 覆盖） | 否 |
...
| 模块架构 | 6 模块 + 1 门户：工作台/回路管理/性能评估/诊断中心/回路整定/系统管理；各模块"配置→运行→分析"三态自包含 |
...
| Action Tracker | 诊断中心子模块，状态机 pending → in_progress → resolved/ignored |
| 统计分析 | 分散到各业务模块"分析"态；自动报表归入系统管理 |
| 回路整定 | Phase 2 落地，Phase 1 仅完成原型页面设计 |
| 工程主约束 | PRD v3.0 为唯一事实来源；UI/UX v4.0 为唯一 UI/UX 输入 |
...
| 下一阶段 | 必读顺序 | 使用方式 | 不要引用 |
|---|---|---|---|
| `/plan-eng-review` | PRD v3.0 → ADS v3.0 → DDS v3.0 → IDS v3.0 → FDS v3.0 | 先定产品主线、架构、数据模型，再拆工程模块 | 不要把 v2.x 或 PRS v0.4 当现行需求 |
| `/plan-design-review` | PRD v3.0 → UI/UX v4.0 → FDS v3.0 | 审查 6 模块+门户、25 页面、AAS Tag UI、配置确认对话框 | 不要把 generic dashboard 或旧 P0 双入口工作台当默认设计 |
| `/plan-ceo-review` | PRD v3.0 → README.md | 审查产品定位、Phase 范围、模块架构 | 不要回滚到 P0 治理闭环验证包口径 |
| PRD 后续修订 | PRD v3.0 → FDS/ADS/DDS/IDS v3.0 → UI/UX v4.0 | 在 v3.0 基础上增量修订，保持派生关系 | 不要回滚到 v2.x 口径 |
| 原型开发 | UI/UX v4.0 → `prototype/src/routes/menuConfig.ts` → DESIGN.md v2.0 | 只做 Phase 1 范围内页面 | 不要承诺真实 AAS 接入、真实整定执行 |
...
- `docs/归档文档/product-requirements-specification-*.md`（所有 PRS 历史版本，已被 PRD v3.0 取代）
- `docs/归档文档/full-product-menu-ia-v0.1-2026-06-16.md`（菜单已并入 UI/UX v4.0 §5）
...
- `docs/归档文档/prototype-visual-tokens-v0.1-2026-06-16.md`（被 UI/UX v4.0 §3 覆盖）
- `docs/归档文档/prototype-responsive-accessibility-v0.1-2026-06-16.md`（被 UI/UX v4.0 §2 覆盖）
- `docs/归档文档/clpm-p0-prototype-spec-package-2026-06-16.md`

### 6.2 已废弃的过程文档

- `docs/过程文档/prototype-development-freeze-v0.1-2026-06-16.md`（任务书已被 UI/UX v4.0 25 页面清单取代）
