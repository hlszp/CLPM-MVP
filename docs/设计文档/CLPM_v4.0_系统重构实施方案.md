...
> **历史实施蓝图（非当前验收基线）**：本文记录 2026-06 的 Phase 0-6 实施计划、当时的文件位置、回滚设想与验收目标。阶段提交已经完成，但后续代码、路由、API、ORM 与测试口径持续演进；当前验收必须以 `README.md`、PRD v6.1、实现契约 v2.1、当前代码与当次 CI 结果为准。本文中的旧路径、特性开关、测试数量或“需新增”事项仅用于历史追溯。

| 项目 | 内容 |
|---|---|
| 文档版本 | v1.0 |
| 发布日期 | 2026-06-26 |
| 文档性质 | 历史重构实施蓝图（非当前验收证明） |
| 适用范围 | CLPM 后端 + 前端全栈重构 |
