...
# KPI 计算引擎单元测试
# ---------------------------------------------------------------------------
# v4.0 重构后旧函数 (_compute_kpis / _compute_composite_score / _is_auto_mode /
# _compute_oscillation_rate / _align_timeseries) 已被 DataPlanner + 12 Calculator +
# ConfidenceEvaluator 三层架构取代。旧引擎测试已移除，新测试在
# test_kpi_calc.py 中覆盖（TestComputeKpisThreeLayer / TestCalculateLoopKpi 等）。
