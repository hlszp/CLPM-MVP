...
def test_diagnosis_run_table_metadata() -> None:
    ...
    expected = {
        "id", "task_id", "loop_id", "triggered_by", "time_window_start", "time_window_end",
        "operator_group", "status", "data_gate", "operator_results", "fusion_results",
        "symptom_tags", "primary_category", "primary_confidence", "secondary_categories",
        "pending_review", "severity", "rationale", "recommendations", "evidence_charts",
