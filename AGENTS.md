...
| 优化整改计划 | `docs/过程文档/clpm-optimization-review-plan-2026-07-28.md` | v1.0（全维度评审 ~90 项问题 + 六阶段方案）；**Phase 0/1 已完成**（2026-07-28：算法 P0×3+P1 全修、TDengine 时区修复、综合评分口径、阈值配置化迁移 `c3d4e5f6a7b8`；pytest 2704 全绿） |
