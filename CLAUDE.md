...
**系统已停止运行**：后端(7101)、前端(5666)、Celery Worker 均已挂掉，需重启。
**核心未解决问题**：KPI 批量回填任务（Celery group 并行）稳定性未验证。

**详见交接文档**：[TROUBLESHOOTING.md](TROUBLESHOOTING.md)（包含完整错误链、修复历程、排查方向、重启命令）

**当前分支**：`mb/feat-data-architecture-optimization`
