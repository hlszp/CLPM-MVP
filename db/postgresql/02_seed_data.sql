...
-- =============================================================================
-- 3 条示例快照，覆盖 8 大 KPI 字段（含 effective_auto_rate/fast_response_rate）
-- 评估窗口：2026-06-21 00:00:00 ~ 01:00:00
-- =============================================================================

INSERT INTO kpi_snapshot_hourly (id, loop_id, ts_start, ts_end, score, good_value_rate, auto_mode_rate, effective_auto_rate, steady_rate, accuracy_rate, fast_response_rate, oscillation_rate, saturation_rate, status) VALUES
