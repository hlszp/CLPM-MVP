...
--       1. 管理员账户（5 个角色用户）
--       2. 工厂节点（1 工厂 + 3 AREA 装置 + 5 UNIT 工艺单元）
...
-- 强制改密说明（S5-AUTH P1）：
--   must_change_password 统一置 TRUE，种子用户首次登录后须先修改密码，
--   改密成功前除改密/登出外的写操作端点一律 403（读端点放行）。
-- =============================================================================
...
('00000000-0000-0000-0000-000000000001', 'admin',       '$2b$12$EmVQ8NwGlB/O8L4vJ0XSluBfxYOlTwBer7vnNFuVL/0qmhSXlfy/u', '系统管理员',     'admin@clpm.local',       'ADMIN',       TRUE, TRUE, NOW(), NOW()),
('00000000-0000-0000-0000-000000000002', 'ic_engineer', '$2b$12$3KxnNHH3KmxeEE6AUmQOeuFEccnBLlHxaDBX5BIWCwvKPq1gqLrxy', '仪控工程师',     'ic_engineer@clpm.local', 'IC_ENGINEER', TRUE, TRUE, NOW(), NOW()),
('00000000-0000-0000-0000-000000000003', 'pe_engineer', '$2b$12$dLInICVCCkfdsIfs6jJnqeJfR0HDzFbv7yqBWboZQSLRknlQuhOKG', '工艺工程师',     'pe_engineer@clpm.local', 'PE_ENGINEER', TRUE, TRUE, NOW(), NOW()),
('00000000-0000-0000-0000-000000000004', 'sponsor',     '$2b$12$lpgnpJwE956RFjcYb4hyOubgVYhf0IDWs0xlBzbCU1RMuT1cmR0sC', '项目发起人',     'sponsor@clpm.local',     'SPONSOR',     TRUE, TRUE, NOW(), NOW()),
...
-- 2.2 装置/车间（AREA）
INSERT INTO plant_node (id, name, type, parent_id, created_at, updated_at) VALUES
('00000000-0000-0000-0000-000000000102', '加氢精制', 'AREA', '00000000-0000-0000-0000-000000000101', NOW(), NOW()),
('00000000-0000-0000-0000-000000000103', '加氢裂化', 'AREA', '00000000-0000-0000-0000-000000000101', NOW(), NOW()),
('00000000-0000-0000-0000-000000000104', 'S Zorb',   'AREA', '00000000-0000-0000-0000-000000000101', NOW(), NOW());

-- 2.3 工艺单元（UNIT，回路挂载层）
INSERT INTO plant_node (id, name, type, parent_id, created_at, updated_at) VALUES
('00000000-0000-0000-0000-000000000111', 'HDS-RX 反应系统', 'UNIT', '00000000-0000-0000-0000-000000000102', NOW(), NOW()),
('00000000-0000-0000-0000-000000000112', 'HDS-FR 分馏系统', 'UNIT', '00000000-0000-0000-0000-000000000102', NOW(), NOW()),
('00000000-0000-0000-0000-000000000113', 'HDC-RX 反应系统', 'UNIT', '00000000-0000-0000-0000-000000000103', NOW(), NOW()),
('00000000-0000-0000-0000-000000000114', 'HDC-FR 分馏系统', 'UNIT', '00000000-0000-0000-0000-000000000103', NOW(), NOW()),
('00000000-0000-0000-0000-000000000115', 'SZB-AD 吸附系统', 'UNIT', '00000000-0000-0000-0000-000000000104', NOW(), NOW());
...
-- =============================================================================
-- 3 条示例快照，覆盖 8 大 KPI 字段（含 effective_auto_rate/fast_rate）
-- 评估窗口：2026-06-21 00:00:00 ~ 01:00:00
-- =============================================================================

INSERT INTO kpi_snapshot_hourly (id, loop_id, ts_start, ts_end, score, good_value_rate, auto_mode_rate, effective_auto_rate, steady_rate, accuracy_rate, fast_rate, oscillation_rate, saturation_rate, status) VALUES
('00000000-0000-0000-0000-000000000801', '00000000-0000-0000-0000-000000000201', '2026-06-21 00:00:00', '2026-06-21 01:00:00', 88.50, 95.20, 98.00, 93.30, 92.30, 90.10, 88.00, 3.20,  1.50, 'SUCCESS'),
('00000000-0000-0000-0000-000000000802', '00000000-0000-0000-0000-000000000202', '2026-06-21 00:00:00', '2026-06-21 01:00:00', 82.30, 91.50, 95.00, 86.92, 85.40, 88.20, 85.00, 5.80,  2.10, 'SUCCESS'),
('00000000-0000-0000-0000-000000000803', '00000000-0000-0000-0000-000000000203', '2026-06-21 00:00:00', '2026-06-21 01:00:00', 65.80, 78.30, 70.00, 54.81, 68.50, 72.40, 60.00, 12.50, 8.30, 'PARTIAL');
